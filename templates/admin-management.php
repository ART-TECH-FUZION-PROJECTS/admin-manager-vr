...
<div class="wrap">
    ...
    <h2 class="admin-mang-wp-notice-placeholder"></h2>

    <div class="admin-mang-global-plugin-wrapper" id="admin-mang-page-management">
        <!-- Main Heading -->
                ...
                <div id="am-pm-tab-general" class="am-pm-tab-content">
                    <div class="am-pm-form-grid">
                        ...
                        ?>
                            ...
                            } elseif ($name === 'auth_client_id') {
                                $placeholder = 'e.g. 618415546365-2qoa...';
                            } else {
                                $placeholder = '';
                            }
                            ?>
